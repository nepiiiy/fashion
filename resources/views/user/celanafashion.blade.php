...
<style>
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <form action="{{ route('pants') }}" method="get" id="filterForm">
            ...
            <div class="col-10">
                ...
                <form action="pants/searchpants" method="GET" class="d-flex justify-content-end" role="searchpants">
                    <div class="row mb-3">
                        <div class="col-10">

                            <input type="text" class="form-control form-control-sm" value="" placeholder="Ketik Disini" name="searchpants" id="searchpants" autofocus value="{{ old('search') }}">
                        </div>
                        <div class="col-1">
                ...
                <div class="col-3">
                    <div class="card" style="height: 32rem">
                        <figure class="tv-thumb-card-tm">
                            <img src="{{ asset('storage/' . $data->gambar_celana) }}" class="card-img-top" alt="..."
                            style="height: 250px; object-fit: cover;">
                        <div class="tv-card-category-tm" style="background-color:#b4b7ba;">
                            <p data-value="{{ $data->cate_pant_id }}">
                                {{ $kategori->where('id', $data->cate_pant_id)->first()->name_kategori }}
                            </p>
                        </div>
                    </figure>
                        <div class="card-body">
                            <a href="/lihatcelana/{{ $data->id }}" class="link-card">
                                <h5 class="card-title"><b>{{ Str::limit($data->name_celana) }}</b></h5>
                            </a>
                            <p class="card-text" style="font-size: 12px">{!! Str::limit($data->deskripsi_celana) !!}</p>
                            <a href="/lihatcelana/{{ $data->id }}" class="btn btn-sm btn-outline-dark">BACA</a>
                        </div>
                    </div>
                </div>
            @endforeach
