...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <form action="{{ route('clothes') }}" method="get" id="filterForm">
            ...
            <div class="col-10">
                <form action="clothes/search" method="GET" class="d-flex justify-content-end" role="search">
                    <div class="row mb-3">
                        <div class="col-10">
                            <input type="text" class="form-control form-control-sm" value=""
                                placeholder="Ketik Disini" name="search" id="search" autofocus">
                        </div>
                        <div class="col-1">
