...
<style>
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <form action="{{ route('shoe') }}" method="get" id="filterForm">
            ...
            <div class="col-10">
                ...
                <form action="shoe/searchsepatu" method="GET" class="d-flex justify-content-end" role="search">
                    <div class="row mb-3">
                        <div class="col-10">

                            <input type="text" class="form-control form-control-sm" value=""
                                placeholder="Ketik Disini" name="searchsepatu" id="searchsepatu">
                        </div>
                        <div class="col-1">
                ...
                <div class="col-3">
                    <div class="card" style="height: 32rem">
                        <figure class="tv-thumb-card-tm">
                            <img src="{{ asset('storage/' . $data->gambar_sepatu) }}" class="card-img-top" alt="..."
                            style="height: 250px; object-fit: cover;">
                        <div class="tv-card-category-tm" style="background-color:#b4b7ba;">
                            <p data-value="{{ $data->kat__sepatu_id }}">
                                {{ $kategori->where('id', $data->kat__sepatu_id)->first()->name_kategori }}
                            </p>
                        </div>
                    </figure>
                        <div class="card-body">
                            <a href="#" class="link-card">
                                <h5 class="card-title"><b>{{ Str::limit($data->name_sepatu, 50) }}</b></h5>
                            </a>
                            <p class="card-text" style="font-size: 12px">{!! Str::limit($data->deskripsi_sepatu, 150) !!}</p>
                            <a href="/lihatsepatu/{{ $data->id }}" class="btn btn-sm btn-outline-dark">BACA</a>
                        </div>
                    </div>
                </div>
            @endforeach
