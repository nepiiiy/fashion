...
<style>
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <form action="{{ route('hat') }}" method="get" id="filterForm">
            ...
            <div class="col-10">
                ...
                <form action="hat/searchtopi" method="GET" class="d-flex justify-content-end" role="search">
                    <div class="row mb-3">
                        <div class="col-10">
                            <input type="text" class="form-control form-control-sm" value=""
                                placeholder="Ketik Disini" name="searchtopi" id="searchtopi" autofocus>
                        </div>
                        <div class="col-1">
                ...
                <div class="col-3">
                    <div class="card" style="height: 35rem">
                        <figure class="tv-thumb-card-tm">
                            <img src="{{ asset('storage/' . $data->gambar_topi) }}" class="card-img-top" alt="..."
                            style="height: 250px; object-fit: cover;">
                        <div class="tv-card-category-tm" style="background-color:#b4b7ba;">
                            <p data-value="{{ $data->kat__topi_id }}">
                                {{ $kategori->where('id', $data->kat__topi_id)->first()->name_kategori }}
                            </p>
                        </div>
                    </figure>
                        <div class="card-body">
                            <a href="#" class="link-card">
                                <h5 class="card-title"><b>{{ Str::limit($data->name_topi, 50) }}</b></h5>
                            </a>
                            <p class="card-text" style="font-size: 12px">{!! Str::limit($data->deskripsi_topi, 150) !!}</p>
                            <a href="/lihattopii/{{ $data->id }}" class="btn btn-sm btn-outline-dark">BACA</a>
                        </div>
                    </div>
                </div>
            @endforeach
