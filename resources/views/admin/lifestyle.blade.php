    ...
    <div class="container">
                    ...
                    <div class="card" style="width: 15rem; height:25rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="align-items-start">
                                ...
                                <a href="#" data-id="{{ $data->id }}" data-nama="{{ $data->judul_style }}"
        ...
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
                <form action="/insertStyle" method="POST" enctype="multipart/form-data" class="row g-3">
                    @method('POST')
                    @csrf
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <input type="text" class="form-control @error('judul_style') is-invalid @enderror"
                                    name="judul_style" id="judul_style">
                                @error('judul_style')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <div class="modal fade" id="exampleModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="/update-style/{{$data->id}}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <input type="text" class="form-control @error('judul_style') is-invalid @enderror judul_style"
                                name="judul_style" id="judul_style" value="{{$data->judul_style}}">
                            @error('judul_style')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteStyle/" + bajuid + ""
